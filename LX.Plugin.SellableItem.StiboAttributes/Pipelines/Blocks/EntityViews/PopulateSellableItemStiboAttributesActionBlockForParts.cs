...
{
    [PipelineDisplayName(SellableItemStiboAttributesConstants.Pipelines.Blocks.PopulateSellableItemStiboAttributesActionBlockForParts)]
    public class PopulateSellableItemStiboAttributesActionBlockForParts :
   PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public override Task<EntityView> Run(EntityView arg, CommercePipelineExecutionContext context)
        {
            ...
            if (string.IsNullOrEmpty(arg?.Name) || !arg.Name.Equals(viewsPolicy.Parts, StringComparison.OrdinalIgnoreCase))
            {
            ...
            actionPolicy.Actions.Add(
                ...
                {
                    Name = context.GetPolicy<SellableItemStiboAttributesActionsPolicy>().Parts,
